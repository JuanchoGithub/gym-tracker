...
export const es = {
  ...
  train_empty_workout_subtext: 'Sin ejercicios, registrá a medida que avanzás',
  ...
  wizard_step_1_question: '¿Cuánta experiencia tenés levantando pesas?',
  wizard_option_beginner: 'Principiante',
  wizard_option_beginner_desc: 'Soy nuevo o estoy retomando.',
  wizard_option_intermediate: 'Intermedio',
  wizard_option_intermediate_desc: 'Conozco lo básico y quiero estructura.',
  wizard_option_advanced: 'Avanzado',
  wizard_option_advanced_desc: 'He entrenado constantemente por años.',
  wizard_step_2_question: '¿Cuál es tu objetivo principal ahora?',
  wizard_option_strength: 'Ganar Fuerza',
  wizard_option_strength_desc: 'Enfocarse en levantar más peso.',
  wizard_option_muscle: 'Ganar Músculo',
  wizard_option_muscle_desc: 'Enfocarse en hipertrofia y forma.',
  wizard_option_endurance: 'Perder Grasa / Resistencia',
  wizard_option_endurance_desc: 'Más repeticiones, ritmo más rápido.',
  wizard_step_3_question: '¿Dónde vas a entrenar?',
  wizard_option_gym: 'Gimnasio Completo',
  wizard_option_gym_desc: 'Acceso a barras, máquinas y poleas.',
  wizard_option_dumbbell: 'Casa (Mancuernas)',
  wizard_option_dumbbell_desc: 'Equipo limitado, principalmente mancuernas.',
  wizard_option_bodyweight: 'Solo Peso Corporal',
  wizard_option_bodyweight_desc: 'Sin equipo necesario.',
  wizard_step_4_question: '¿Cuánto tiempo tenés por entrenamiento?',
  wizard_option_short: 'Rápido (< 30 mins)',
  wizard_option_medium: 'Estándar (45-60 mins)',
  wizard_option_long: 'Largo (> 60 mins)',
  wizard_generating: 'Generando tu plan...',
  wizard_complete_title: 'Creamos un plan personalizado para vos.',
  wizard_complete_desc: 'Basado en tus respuestas, hemos generado {count} rutinas. Ahora están guardadas en "Mis Plantillas".',
  wizard_complete_action: 'Guardar y Ver Rutinas',

  // Generated Routines
  wizard_routine_full_body_a_name: "Cuerpo Completo A",
  wizard_routine_full_body_a_desc: "Enfoque en movimientos compuestos. Sugerido: Lunes y Viernes.",
  wizard_routine_full_body_b_name: "Cuerpo Completo B",
  wizard_routine_full_body_b_desc: "Entrenamiento complementario. Sugerido: Miércoles.",
  wizard_routine_upper_name: "Tren Superior",
  wizard_routine_upper_desc: "Enfoque en músculos del torso. Sugerido: Lunes y Jueves.",
  wizard_routine_lower_name: "Tren Inferior",
  wizard_routine_lower_desc: "Enfoque en piernas y core. Sugerido: Martes y Viernes.",
  wizard_routine_push_name: "Día de Empuje",
  wizard_routine_push_desc: "Pecho, Hombros, Tríceps. Sugerido: Días 1 y 4.",
  wizard_routine_pull_name: "Día de Tirón",
  wizard_routine_pull_desc: "Espalda y Bíceps. Sugerido: Días 2 y 5.",
  wizard_routine_legs_name: "Día de Piernas",
  wizard_routine_legs_desc: "Cuádriceps, Glúteos, Pantorrillas. Sugerido: Días 3 y 6.",
  ...
  rec_title_onboarding_complete: "Tu Plan está Listo",
  ...
  rec_reason_trained_today: "Entrenaste hoy. ¡Buen trabajo! Ahora descansá y recuperate.",
  rec_reason_onboarding_complete: "Creamos estas rutinas basadas en tu objetivo. ¡Tocá una para empezar!",
  rec_reason_next_up: "Continuando con tu plan. Es hora de {routine}.",
  rec_reason_rest_growth: "Entrenaste ayer. La recuperación es cuando los músculos crecen.",
  ...
  rec_title_promotion: "Nivel Superado: {exercise}",
  progression_reason_squat: "Has dominado la {from}. Tus piernas son lo suficientemente fuertes para la {to}, que permite mayor carga.",
  progression_reason_bench: "Tu fuerza en flexiones es sólida. Es hora de construir potencia bruta con el {to}.",
  progression_reason_pullup: "Tu fuerza de remo es excelente. Estás listo para graduarte a la {to}.",
  progression_reason_deadlift: "Has dominado el patrón de bisagra de cadera con {from}. Estás listo para el {to}.",

  // Lifter DNA
  dna_archetype_powerbuilder_label: 'El Powerbuilder',
  dna_archetype_powerbuilder_desc: 'Levantas pesado y enfocado. La fuerza es tu juego.',
  dna_archetype_bodybuilder_label: 'El Culturista',
  dna_archetype_bodybuilder_desc: 'Te enfocas en volumen e hipertrofia. Buscando el bombeo.',
  dna_archetype_endurance_label: 'La Máquina',
  dna_archetype_endurance_desc: 'Repeticiones altas y poco descanso. Puedes seguir todo el día.',
  dna_archetype_hybrid_label: 'El Híbrido',
  dna_archetype_hybrid_desc: 'Un enfoque equilibrado entre fuerza y fitness.',
  dna_archetype_beginner_label: 'El Novato',
  dna_archetype_beginner_desc: 'Recién empezando. La consistencia es tu primer objetivo.',
  dna_stats_consistency: 'Consistencia',
  dna_stats_volume: 'Volumen',
  dna_stats_intensity: 'Intensidad',
  dna_stats_favorite_muscle: 'Músculo Favorito',
  ...
  exercise_anatomy_toggle_primary: 'Principal',
  exercise_anatomy_toggle_secondary: 'Secundario',
  exercise_anatomy_whole: 'Todo {part}',
  heatmap_front: 'FRENTE',
  heatmap_back: 'DORSO',
  heatmap_fresh: 'Fresco',
  heatmap_fatigued: 'Fatigado',
  heatmap_hover_hint: 'Mantené presionado para ver detalles',
  ...
  profile_unlock_history_title: 'Historial de Logros',
  profile_unlock_message: 'Graduado de {from} a {to}',
  ...
  active_workout_suggest_button: '¿Qué podría hacer ahora?',
  active_workout_suggestion_title: 'Sugerido: {name}',
  active_workout_suggestion_reason: 'Esta rutina se generó porque tus músculos de {focus} están frescos y listos para entrenar.',
  active_workout_suggestion_reason_start: 'Esta es la primera rutina de tu plan generado. ¡Perfecta para empezar!',
  active_workout_accept_suggestion: 'Cargar Rutina',
