...
export const en_train = {
  ...
  workout_validation_error_title: "Cannot Finish Workout",
  workout_validation_error_msg: "Please correct the following errors:",
  workout_error_weight: "Set {set}: Missing Weight",
  workout_error_reps: "Set {set}: Missing Reps",
  workout_error_time: "Set {set}: Missing Time",
  ...
  timers_side_left: "LEFT SIDE",
  timers_side_right: "RIGHT SIDE",
  timers_switch: "SWITCH SIDES",
