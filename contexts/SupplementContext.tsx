...
export const SupplementProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
    ...
    const importSupplementData = useCallback((data: any) => {
        ...
        if (data.dismissedSuggestions) setDismissedSuggestions(data.dismissedSuggestions);
    }, [setSupplementPlan, setUserSupplements, setTakenSupplements, setSupplementLogs, setSnoozedSupplements, setDayOverrides, setDismissedSuggestions]);
