...
export const BACK_EXERCISES: Exercise[] = [
  ...
  { id: 'ex-40', name: 'Single-Arm Dumbbell Row', bodyPart: 'Back', category: 'Dumbbell', primaryMuscles: [MUSCLES.LATS], secondaryMuscles: [MUSCLES.BICEPS, MUSCLES.BRACHIALIS, MUSCLES.FOREARMS, MUSCLES.WRIST_FLEXORS, MUSCLES.RHOMBOIDS, MUSCLES.REAR_DELTS] },
  ...
  { id: 'ex-47', name: 'Renegade Row', bodyPart: 'Back', category: 'Dumbbell', primaryMuscles: [MUSCLES.LATS, MUSCLES.ABS], secondaryMuscles: [MUSCLES.BICEPS, MUSCLES.BRACHIALIS, MUSCLES.FOREARMS, MUSCLES.WRIST_FLEXORS, MUSCLES.FRONT_DELTS, MUSCLES.OBLIQUES] },
  { id: 'ex-48', name: 'Meadows Row', bodyPart: 'Back', category: 'Barbell', primaryMuscles: [MUSCLES.LATS, MUSCLES.RHOMBOIDS], secondaryMuscles: [MUSCLES.BICEPS, MUSCLES.BRACHIALIS, MUSCLES.FOREARMS, MUSCLES.WRIST_FLEXORS, MUSCLES.REAR_DELTS] },
  ...
  { id: 'ex-148', name: 'Kettlebell High Pull', bodyPart: 'Back', category: 'Kettlebell', primaryMuscles: [MUSCLES.TRAPS, MUSCLES.REAR_DELTS], secondaryMuscles: [MUSCLES.LATS, MUSCLES.BICEPS, MUSCLES.FOREARMS, MUSCLES.WRIST_FLEXORS] },
];
