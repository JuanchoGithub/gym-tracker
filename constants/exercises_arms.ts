...
export const ARM_EXERCISES: Exercise[] = [
  ...
  { id: 'ex-74', name: 'Concentration Curl', bodyPart: 'Biceps', category: 'Dumbbell', isUnilateral: true, primaryMuscles: [MUSCLES.BICEPS], secondaryMuscles: [MUSCLES.BRACHIALIS, MUSCLES.FOREARMS, MUSCLES.WRIST_FLEXORS] },
  ...
  { id: 'ex-92', name: 'Kickback', bodyPart: 'Triceps', category: 'Dumbbell', isUnilateral: true, primaryMuscles: [MUSCLES.TRICEPS], secondaryMuscles: [MUSCLES.REAR_DELTS] },
  ...
  { id: 'ex-94', name: 'Cross-Body Extension', bodyPart: 'Triceps', category: 'Dumbbell', isUnilateral: true, primaryMuscles: [MUSCLES.TRICEPS], secondaryMuscles: [MUSCLES.FOREARMS] },
