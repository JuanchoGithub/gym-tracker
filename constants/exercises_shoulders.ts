...
export const SHOULDER_EXERCISES: Exercise[] = [
  ...
  { id: 'ex-61', name: 'Cable Lateral Raise', bodyPart: 'Shoulders', category: 'Cable', primaryMuscles: [MUSCLES.SIDE_DELTS], secondaryMuscles: [MUSCLES.FOREARMS] },
  ...
  { id: 'ex-64', name: 'Egyptian Lateral Raise', bodyPart: 'Shoulders', category: 'Dumbbell', primaryMuscles: [MUSCLES.SIDE_DELTS], secondaryMuscles: [MUSCLES.FOREARMS] },
