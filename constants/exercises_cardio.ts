...
export const CARDIO_MOBILITY_EXERCISES: Exercise[] = [
  ...
  { id: 'ex-145', name: 'Turkish Get-Up', bodyPart: 'Full Body', category: 'Kettlebell', isUnilateral: true, primaryMuscles: [MUSCLES.FRONT_DELTS, MUSCLES.ABS], secondaryMuscles: [MUSCLES.QUADS, MUSCLES.GLUTES, MUSCLES.TRICEPS] },
  { id: 'ex-146', name: 'Kettlebell Clean & Press', bodyPart: 'Full Body', category: 'Kettlebell', isUnilateral: true, primaryMuscles: [MUSCLES.FRONT_DELTS, MUSCLES.GLUTES, MUSCLES.HAMSTRINGS], secondaryMuscles: [MUSCLES.TRICEPS, MUSCLES.TRAPS] },
  { id: 'ex-147', name: 'Kettlebell Snatch', bodyPart: 'Full Body', category: 'Kettlebell', isUnilateral: true, primaryMuscles: [MUSCLES.GLUTES, MUSCLES.HAMSTRINGS, MUSCLES.FRONT_DELTS], secondaryMuscles: [MUSCLES.LOWER_BACK, MUSCLES.TRAPS] },
  ...
  { id: 'ex-153', name: 'Foam Rolling', bodyPart: 'Mobility', category: 'Bodyweight', isTimed: true, isUnilateral: true, primaryMuscles: [], secondaryMuscles: [] },
