...
export const LEG_EXERCISES: Exercise[] = [
  ...
  { id: 'ex-99', name: 'Dumbbell Walking Lunge', bodyPart: 'Legs', category: 'Dumbbell', primaryMuscles: [MUSCLES.QUADS, MUSCLES.GLUTES], secondaryMuscles: [MUSCLES.HAMSTRINGS, MUSCLES.CALVES, MUSCLES.ADDUCTORS, MUSCLES.FOREARMS, MUSCLES.WRIST_FLEXORS] },
  { id: 'ex-100', name: 'Bulgarian Split Squat', bodyPart: 'Legs', category: 'Dumbbell', primaryMuscles: [MUSCLES.QUADS, MUSCLES.GLUTES], secondaryMuscles: [MUSCLES.HAMSTRINGS, MUSCLES.ADDUCTORS, MUSCLES.FOREARMS, MUSCLES.WRIST_FLEXORS] },
  ...
  { id: 'ex-103', name: 'Dumbbell Step-Up', bodyPart: 'Legs', category: 'Dumbbell', primaryMuscles: [MUSCLES.QUADS, MUSCLES.GLUTES], secondaryMuscles: [MUSCLES.CALVES, MUSCLES.HAMSTRINGS, MUSCLES.FOREARMS, MUSCLES.WRIST_FLEXORS] },
