...
export const CHEST_EXERCISES: Exercise[] = [
  ...
  { id: 'ex-28', name: 'Landmine Press', bodyPart: 'Chest', category: 'Barbell', isUnilateral: true, primaryMuscles: [MUSCLES.UPPER_CHEST, MUSCLES.FRONT_DELTS], secondaryMuscles: [MUSCLES.TRICEPS, MUSCLES.SERRATUS_ANTERIOR] },
  ...
  { id: 'ex-30', name: 'Archer Push-Up', bodyPart: 'Chest', category: 'Bodyweight', isUnilateral: true, primaryMuscles: [MUSCLES.PECTORALS, MUSCLES.TRICEPS], secondaryMuscles: [MUSCLES.FRONT_DELTS, MUSCLES.ABS] },
