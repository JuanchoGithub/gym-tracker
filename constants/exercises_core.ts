...
export const CORE_EXERCISES: Exercise[] = [
  ...
  { id: 'ex-119', name: 'Woodchopper', bodyPart: 'Core', category: 'Cable', isUnilateral: true, primaryMuscles: [MUSCLES.OBLIQUES, MUSCLES.ABS], secondaryMuscles: [MUSCLES.FRONT_DELTS] },
  { id: 'ex-120', name: 'Pallof Press', bodyPart: 'Core', category: 'Cable', isUnilateral: true, primaryMuscles: [MUSCLES.OBLIQUES, MUSCLES.TRANSVERSE_ABDOMINIS], secondaryMuscles: [MUSCLES.ABS] },
  { id: 'ex-121', name: 'Bird Dog', bodyPart: 'Core', category: 'Bodyweight', isUnilateral: true, primaryMuscles: [MUSCLES.LOWER_BACK, MUSCLES.ABS], secondaryMuscles: [MUSCLES.GLUTES, MUSCLES.FRONT_DELTS] },
  ...
  { id: 'ex-127', name: 'Side Bend', bodyPart: 'Core', category: 'Dumbbell', isUnilateral: true, primaryMuscles: [MUSCLES.OBLIQUES], secondaryMuscles: [MUSCLES.FOREARMS] },
  ...
  { id: 'ex-157', name: 'Side Plank', bodyPart: 'Core', category: 'Bodyweight', isTimed: true, isUnilateral: true, primaryMuscles: [MUSCLES.OBLIQUES], secondaryMuscles: [MUSCLES.ABS, MUSCLES.SIDE_DELTS] },
