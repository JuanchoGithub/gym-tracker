        ...
        >
            ...
            {!isCollapsed && (
                <div className="p-3 sm:p-4 space-y-2 bg-gradient-to-b from-surface to-background/50 rounded-b-2xl">
                    ...
                    <div className="grid grid-cols-[38px_1fr_1.1fr_0.9fr_48px] items-center gap-1.5 text-[10px] sm:text-xs font-bold text-text-secondary uppercase tracking-wider mb-2 px-2">
