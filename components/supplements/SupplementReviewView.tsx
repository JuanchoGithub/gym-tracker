        ...
        <div className="fixed inset-0 bg-background z-50 flex flex-col overflow-hidden animate-fadeIn">
            ...
            <div className="flex justify-center border-b border-white/10 bg-surface/50">
                <button
                    ...
                    className={`px-6 py-3 font-medium transition-colors relative ${activeTab === 'suggestions' ? 'text-primary' : 'text-text-secondary hover:text-white'}`}
                >
                ...
                <button
                    ...
                    className={`px-6 py-3 font-medium transition-colors relative ${activeTab === 'analysis' ? 'text-primary' : 'text-text-secondary hover:text-white'}`}
                >
